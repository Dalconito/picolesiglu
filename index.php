...
<body>
  ...
  <section class="pagina">
    ...
    <div class="LojaDiv">
      ...
      <a class="btnLoja" href="redessociais.php">Conheça Nossa Loja</a>
    </div>
    ...
    <p class="tituloChamativo">Principais Produtos</p>
    <div class="produtoDiv">
      <div class="produtoItem">
        <img src="./public/fotos/foto1.webp">
        <p class="">Picolé Comum</p>
      </div>
      <div class="produtoItem">
        <img src="./public/fotos/foto2.webp">
        <p class="">Picolé com Cobertura</p>
      </div>
      <div class="produtoItem">
        <img src="./public/fotos/foto3.webp">
        <p class="">Sorvete de Massa</p>
      </div>
      <div class="produtoItem">
        <img src="./public/fotos/foto4.webp">
        <p class="">Açaí</p>
      </div>
    </div>
